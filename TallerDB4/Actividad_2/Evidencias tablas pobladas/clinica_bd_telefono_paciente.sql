...
CREATE TABLE `telefono_paciente` (
  ...
  KEY `fk_telefono_paciente_tb_paciente1_idx` (`tb_paciente_id_paciente`),
  CONSTRAINT `fk_telefono_paciente_tb_paciente1` FOREIGN KEY (`tb_paciente_id_paciente`) REFERENCES `tb_paciente` (`id_paciente`)
...
INSERT INTO `telefono_paciente` VALUES ('320-888888',1),('310-999999',2),('315-000000',3),('319-777777',4),('315-666666',5);
